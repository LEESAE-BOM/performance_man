...
class _contracted_price extends State<contracted_price> {
  List<ChartData> chartData = <ChartData>[
    ChartData('1월', 84452000,74642000,48624000),
    ChartData('2월', 68175000,45678000,45612000),
    ChartData('3월', 77774000,12312444,45612000),
    ChartData('4월', 50732000,74185000,96385000),
            ...
            child: ListView(
              children:<Widget> [Column(
                ...
                children: <Widget>[
                  Text.rich(TextSpan(
                      text: '이번 달 ',
                      style: TextStyle(fontSize: 25.0, letterSpacing: 2.0,fontFamily: 'AppleB'),
                      children: <TextSpan>[
                        TextSpan(
                          text: '계약 금액',
                          style: TextStyle(
                      ...
                      Text.rich(TextSpan(text: '', children: <TextSpan>[
                        TextSpan(
                          ...
                          style: TextStyle(
                            ...
                            color: Colors.blue,
                            letterSpacing: 2.0,
                            fontWeight: FontWeight.bold, fontFamily: 'AppleB'
                          ),
                        ),
                        TextSpan(
                            text: '이에요.',
                            style: TextStyle(
                                fontSize: 25.0,
                                letterSpacing: 2.0,
                                color: Colors.black,fontFamily: 'AppleB')),
                      ]))
                    ],
                  ),
                  SizedBox(
