...
Future<void> machine() async {
  ...
  final rawCsvContent =
      await rootBundle.loadString('dataset/machine_sample_2016.csv');
  final samples_2016 = DataFrame.fromRawCsv(rawCsvContent, headerExists: true);

  final rawCsvContent2 =
      await rootBundle.loadString('dataset/machine_sample_2017.csv');
  final samples_2017 = DataFrame.fromRawCsv(rawCsvContent2, headerExists: true);

  final rawCsvContent3 =
      await rootBundle.loadString('dataset/machine_sample_2018.csv');
  final samples_2018 = DataFrame.fromRawCsv(rawCsvContent3, headerExists: true);

  final rawCsvContent4 =
      await rootBundle.loadString('dataset/machine_sample_2019.csv');
  final samples_2019 = DataFrame.fromRawCsv(rawCsvContent4, headerExists: true);

  final rawCsvContent5 =
      await rootBundle.loadString('dataset/machine_sample_2020.csv');
