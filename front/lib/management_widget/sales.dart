...
import 'package:flutter_app/date_calculator.dart';
              ...
              child: FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      thisMonthPrice = thisMonthPrice.substring(
                          0, thisMonthPrice.length - 3);
                      previousMonthPrice = previousMonthPrice.substring(
                          0, previousMonthPrice.length - 3);
                      int diff = int.parse(thisMonthPrice) -
                                ...
                                child: Text.rich(
                                    TextSpan(
                                        children: [
                                          ...
                                          if(diff >= 0)
                                            HeaderTheme().makeHeaderText('[$diff]원 감소했어요.')
                                        ]
                                    )
                                )
                            ),
